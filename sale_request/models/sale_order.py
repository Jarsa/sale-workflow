...
class SaleOrder(models.Model):
    ...
    base_sale_order = fields.Boolean(
    ...
    def action_cancel(self):
        for rec in self:
            if rec.base_sale_order and any(
...
class SaleOrderLine(models.Model):
    ...
    base_sale_order = fields.Boolean(
        related='order_id.base_sale_order',
        help='If you check this field, this sale order do not run any '
        'procurement and will be selectionable when you request '
        'a product defined in this order.',
    )
    parent_id = fields.Many2one(
        ...
        copy=False,
        readonly=True,
        help='Parent sale order line (base sale order).'
    )
    ...
    def _action_launch_stock_rule(self):
        ...
        stock rules when a sale order is a base sale order"""
        if all([order.base_sale_order for order in self.mapped('order_id')]):
            return True
